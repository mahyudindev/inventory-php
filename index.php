...
<div class="row">
 <!-- Left col -->
        <section class="">
          ...
          <!-- <div class="row"> -->
          <div class="row" style="margin-left: 8px; margin-right: 8px; margin-top  : 50px;">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border" style="text-align: center;">
              <h3 class="box-title">Barang dengan Stok paling banyak</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered">
               ...
               <thead>
<?php
          $mySql  = "SELECT nama,sisa FROM barang ORDER BY sisa DESC LIMIT 20";
